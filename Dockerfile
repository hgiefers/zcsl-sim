...
RUN cd ; git clone https://github.com/hgiefers/zcsl.git ; cd zcsl/hdl ; mkdir 3rd_party ; cd 3rd_party ; wget http://pmilder.ece.stonybrook.edu/dftgen/vfiles/spiral-dft1479915207.v ; mv spiral-dft1479915207.v spiral-dft.v
